# FORGE-NOTE-020 — Always-On Orchestration Overhead in the Locked A/B/C Runtime Run
...
> What did the then-current full FORGE orchestration path actually do per request, and how much compute did that behavior cost?
...
- **C** — then-current full FORGE orchestration
...
The architectural change is that FORGE should not automatically pay for every available reasoning stage on every request.
