...
Before FORGE could build a trusted corpus, it needed a deterministic plan for what knowledge should exist,
...
After suppressing **7 existing aliases**, FORGE produced:
