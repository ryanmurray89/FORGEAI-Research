# FORGE-NOTE-011 — Automated Research Evidence Capture and NexLedger Attestation
...
FORGE already produced useful telemetry and benchmark artifacts, but research evidence is much less useful if it
...
The evidence path spans FORGE's existing hosts:
...
That gives FORGE a durable evidence path for both:
...
This separation allows FORGE to preserve normal application/database semantics while still creating a tamper-evident external provenance record for selected research evidence.
