# FORGE-NOTE-015 — Trusted Knowledge Indexing Boundary and Private-Data Exclusion
...
After the clean 423-claim production cutover, FORGE needed a controlled way for newly promoted trusted knowledge
...
FORGE therefore keeps lifecycle state, provenance, verification, approval, and authoritative knowledge records
outside Chroma.
