# FORGE-NOTE-021 — Public-Only External Intelligence Refinery and Budgeted Cloud Analysis
...
FORGE's External Intelligence Refinery was built to answer a narrow architectural question:

> Can FORGE use strong hosted inference for background analysis without turning the hosted model into a trust authority or sending private/internal data to it?
...
This component demonstrates an important FORGE design principle:

`external model capacity != external trust authority`

FORGE can borrow high-capability cloud compute for bounded public analysis while retaining:
