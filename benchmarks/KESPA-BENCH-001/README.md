...
The benchmark was designed to test whether KESPA mechanisms materially improve useful small-model
...
| Metric | A — Raw local 7B | B — Verified retrieval | C — KESPA orchestration |
|---|---:|---:|---:|
...
Those ratios describe this benchmark only. They are not claims that KESPA made the language model
