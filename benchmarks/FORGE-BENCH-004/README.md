# FORGE-BENCH-004 — Clean Pilot Retrieval Gate and Contamination-Metric Correction
...
Before scaling the Knowledge Factory beyond its first clean pilot, FORGE tested whether a small evidence-bound corpus
...
After the metric correction, the canonical FORGE research checkpoint recorded:
...
This is the result later surfaced on the FORGE public landing page as a pilot measurement.
...
Instead, FORGE identified that the gate was measuring the wrong thing, tightened the metric, and preserved the distinction between:
...
The final corrected `0/150` / `GO` checkpoint is preserved in the public FORGE research-positioning record; the supplied raw transcript preserves the earlier v001 run before the contamination metric was corrected.
