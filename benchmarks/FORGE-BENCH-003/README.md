# FORGE-BENCH-003 — Atomic Knowledge Retrieval Policy Calibration
...
Do retrieval safeguards designed for long synthetic/legacy cards remain appropriate after FORGE moves
to short, strictly verified atomic claims?

## Context

FORGE had moved to an isolated corpus of **423 verified atomic claims**.
...
### Legacy FORGE minimum-length policy (`min150`)
...
That filter had made sense as a defensive heuristic against weak/short legacy cards. After FORGE moved
...
| Atomic-compatible FORGE ranking | **12/12** | 66/87 | 91.7% | 49.89 ms |
...
FORGE therefore froze **plain_vector_top6** for the later A/B/C evaluation.
