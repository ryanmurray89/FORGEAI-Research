...
How does KESPA's seeded evidence-acquisition and quality-gating pipeline behave when expanded from a
...
of knowledge cards. KESPA did not. The evidence-quality gate held the corpus because only **1,555 of
