# FORGE-EXP-002 — Evidence Discovery: From Search Dependency to Source-First Discovery
...
Can FORGE reliably locate candidate evidence for a fixed representative smoke set using general web
...
FORGE instead tried candidate location in this order:
...
> In this FORGE runtime and fixed smoke set, general web search was not reliable enough to be a required
