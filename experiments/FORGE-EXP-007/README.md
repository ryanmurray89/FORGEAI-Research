# FORGE-EXP-007 — Groq Evidence-Bound Generation Canary and Fail-Closed Verification
...
FORGE ran the evidence-bound pilot generator using:
...
That separation is fundamental to FORGE:
...
The external model could help transform evidence into structured candidate claims, but FORGE retained downstream authority over:
