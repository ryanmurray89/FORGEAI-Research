# FORGE-EXP-006 — Autonomous Trust Policy v0.1 → v0.2 Backlog Reclassification
...
Can FORGE reduce unnecessary human-review load by changing only the supporting-evidence threshold
